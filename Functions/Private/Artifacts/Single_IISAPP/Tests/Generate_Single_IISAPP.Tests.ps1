Describe 'Generate_Single_IISAPP. Tests' {

   Context 'Parameters for Generate_Single_IISAPP.'{
        ...
        It 'ArtifactParam Parameter Position is defined correctly' {
            [String]$Function.Parameters.ArtifactParam.Attributes.Position | Should be '1'
            }
